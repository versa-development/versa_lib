...
function progressBar.init(data)
  ...
  exports['progressbar']:Progress({
    ...
    controlDisables = {
      disableMovement = states.disableMovement,
      disableCarMovement = states.disableDriving,
      disableMouse = states.disableMouseMovement,
      disableCombat = states.disableCombat,
    },
    animation = animation,
    prop = prop or nil,
